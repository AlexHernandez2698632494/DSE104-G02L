...
namespace Empleados.Controllers
{
    public class EmpleadosController : Controller
    {
        ...
        {
            var empleadosDBContext = _context.Empleados.Include(e => e.proyectos);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,lastName,FechaContratacion,proyectosId,asignacionId,puesto")] Empleado empleado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,lastName,FechaContratacion,proyectosId,asignacionId,puesto")] Empleado empleado)
        {
            if (id != empleado.Id)
            {
                return NotFound();
